...
export default function CamouflagePatterns() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Privately-Owned Patterns</h3>
              <p className="text-gray-600 mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-gray-600">Crye Precision — adopted by dozens of national militaries including the UK, Australia, and NATO allies. New fabric development and exclusive international distribution handled by <a href="https://1947llc.com/" target="_blank" rel="noopener noreferrer" className="text-[#1B2845] underline hover:text-blue-700">1947 LLC</a> (Ocean State Innovations)</p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-gray-900">A-TACS</h4>
                  <p className="text-sm text-gray-600">Digital Concealment Systems — alternative tactical pattern with limited military adoption</p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-gray-900">Realtree</h4>
                  <p className="text-sm text-gray-600">Hunting and outdoor market leader, photorealistic designs</p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
      ...
      {/* MultiCam Global Adoption Section */}
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-5">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">MultiCam: The Global Military Standard</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Originally developed by Crye Precision, MultiCam has become the most widely adopted multi-environment 
              combat camouflage in the world — used by dozens of national militaries and allied forces.
            </p>
          </div>
            ...
            <div>
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Military Adoption Worldwide</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>United States:</strong> Deployed with U.S. forces in Afghanistan (2010); OCP — the current standard — is derived from a closely related Scorpion pattern</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>United Kingdom:</strong> Adopted by Royal Marines for the Future Commando Force uniform program on CORDURA® NYCO ripstop</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>Australia:</strong> Australian Defence Force adopted MultiCam as their standard combat pattern</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>NATO & allies:</strong> Widely used across NATO partner nations, creating interoperability across allied forces</p>
                    </div>
                  </div>
                </div>

                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Why MultiCam Won</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>Multi-environment performance:</strong> Effective across woodland, desert, urban, and transitional terrains without pattern changes</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>Battle-proven:</strong> Validated under combat conditions in Afghanistan and Iraq</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>NIR compliant:</strong> Engineered for near-infrared signature management against modern optics</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-600"><strong>Pattern family:</strong> Includes variants — MultiCam Arid, Tropic, Alpine, and Black — for environment-specific needs</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="text-center">
                    <div className="w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                      <svg className="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 2a8 8 0 100 16 8 8 0 000-16zM4.93 4.93a6 6 0 018.14 0l-8.14 8.14a6 6 0 010-8.14zM14.5 10a4.5 4.5 0 01-9 0h9z"/>
                      </svg>
                    </div>
                    <h4 className="text-2xl font-bold text-gray-900 mb-4">MultiCam Fabric Supply Chain</h4>
                    <div className="space-y-4 text-left">
                      <div className="bg-white p-4 rounded-lg border border-blue-200">
                        <div className="font-bold text-blue-600">Crye Precision</div>
                        <div className="text-gray-600 text-sm">Pattern owner and licensor</div>
                      </div>
                      ...
                      <div className="bg-white p-4 rounded-lg border border-blue-200">
                        <div className="font-bold text-blue-600"><a href="https://1947llc.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">1947 LLC / Ocean State Innovations</a></div>
                        <div className="text-gray-600 text-sm">Exclusive international fabric distributor &amp; new fabric development</div>
                      </div>
                      <div className="flex justify-center">
                        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
                      </div>
                      <div className="bg-white p-4 rounded-lg border border-gray-200">
                        <div className="font-bold text-gray-700">Authorized Printers &amp; Converters</div>
                        <div className="text-gray-600 text-sm">Licensed facilities printing onto NYCO, CORDURA®, and other substrates</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {/* Licensing & Procurement Section */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Pattern Ownership & Licensing</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Camouflage patterns fall into distinct categories based on ownership, each with different procurement 
              and licensing requirements for defense and commercial buyers.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">U.S. Government-Owned</h3>
                <div className="space-y-2">
                  <div className="bg-red-50 p-2 rounded text-sm font-medium text-red-700">OCP (Scorpion W2)</div>
                  <div className="bg-red-50 p-2 rounded text-sm font-medium text-red-700">MARPAT</div>
                  <div className="bg-red-50 p-2 rounded text-sm font-medium text-red-700">UCP (discontinued)</div>
                </div>
                <p className="text-gray-600 text-sm mt-4">Restricted to authorized government contracts — not available for commercial licensing</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Privately-Owned (Licensed)</h3>
                <div className="space-y-2">
                  <div className="bg-green-50 p-2 rounded text-sm font-medium text-green-700">MultiCam (Crye Precision)</div>
                  <div className="bg-green-50 p-2 rounded text-sm font-medium text-green-700">A-TACS</div>
                  <div className="bg-green-50 p-2 rounded text-sm font-medium text-green-700">Realtree / Mossy Oak</div>
                </div>
                <p className="text-gray-600 text-sm mt-4">Available to both military buyers and commercial markets through authorized distributors</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Unlicensed Copies</h3>
                <div className="space-y-2">
                  <div className="bg-yellow-50 p-2 rounded text-sm font-medium text-yellow-700">&ldquo;MC-Style&rdquo;</div>
                  <div className="bg-yellow-50 p-2 rounded text-sm font-medium text-yellow-700">&ldquo;Multi-Cam&rdquo;</div>
                  <div className="bg-yellow-50 p-2 rounded text-sm font-medium text-yellow-700">&ldquo;Tactical Camo&rdquo;</div>
                </div>
                <p className="text-gray-600 text-sm mt-4">Unauthorized imitations — no NIR compliance, no quality control, potential IP liability</p>
              </div>
            </div>

            <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-200">
              <h4 className="font-bold text-gray-900 mb-2">Why This Matters for Procurement</h4>
              <p className="text-gray-700">
                MultiCam occupies a unique position: it is the dominant privately-owned combat pattern adopted by military 
                forces worldwide, while also being available for commercial and law enforcement procurement through Crye 
                Precision&rsquo;s exclusive international distributor, <a href="https://1947llc.com/" target="_blank" rel="noopener noreferrer" className="text-[#1B2845] underline hover:text-blue-700">1947 LLC</a> (a division of Ocean State Innovations). Government-owned patterns like OCP and MARPAT remain 
                restricted to official defense contracts, making MultiCam the standard for international military buyers, 
                allied forces, and professional tactical markets alike.
              </p>
            </div>
          </div>
        </div>
