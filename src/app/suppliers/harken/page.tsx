      ...
      <footer className="bg-[#102a43] text-white py-10">
        <div className="max-w-7xl mx-auto px-5">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">Harken Products</h3>
              <ul className="space-y-2">
                <li><a href="#marine-hardware-accessories-products" className="text-gray-300 hover:text-white transition-colors">Featured Items</a></li>
                <li><Link href="/catalog" className="text-gray-300 hover:text-white transition-colors">Full Catalog</Link></li>
                <li><a href="https://www.harken.com" target="_blank" className="text-gray-300 hover:text-white transition-colors">Visit Harken.com</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li className="text-sm mt-4">Authorized Harken Dealer</li>
              </ul>
            </div>
          </div>
